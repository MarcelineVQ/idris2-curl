...
data CurlOption : OptType -> Type where
  ...
  CURLOPT_XFERINFODATA : CurlOption CURLOPTTYPE_OBJECTPOINT -- aka CURLOPT_PROGRESSDATA
  ...
  CURLOPT_SERVER_RESPONSE_TIMEOUT : CurlOption CURLOPTTYPE_LONG -- aka CURLOPT_FTP_RESPONSE_TIMEOUT
